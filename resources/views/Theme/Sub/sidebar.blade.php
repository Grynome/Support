...
<nav class="sidebar">
    ...
    <div class="sidebar-body">
        <ul class="nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="reports">
                        <ul class="nav sub-menu">
                            ...
                            @if (($role == 16 && $depart == 4) || $role == 15 || $role == 20)
                                <li class="nav-item">
                            ...
                            @endif
                            @if ($role == 19 || $role == 20 || $role == 15 || ($role == 16 && ($depart == 3 || $depart == 5 || ($depart == 6 && $depart == 13) || $depart == 10)))
                                @if ($depart != 3 && $depart != 6 && $depart != 10)
                                    <li class="nav-item">
            ...
            @endif
            @if ($depart == 5 || $depart == 4 || $role == 20 || $role == 15)
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="forms">
                        <ul class="nav sub-menu">
                            @if ($depart == 5 || $depart == 4 || $role == 20 || $role == 15)
                                @if (($depart == 4 && $role == 19) || $role == 20 || $role == 15)
                                    <li class="nav-item">
