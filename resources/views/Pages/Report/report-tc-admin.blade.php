                            ...
                            <div class="col-md-12 text-center">
                                ...
                                <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                    <div class="btn-group me-2" role="group" aria-label="First group">
                                        ...
                                        &nbsp;
                                        <form action="{{url("export-ticket/Report=Ticket/Admin")}}" method="POST">
                                            @csrf
                                ...
                                <div class="modal fade" id="filter-report-ticket" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('sort.tc.report') }}" method="post">
                                                @csrf
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-md-12 mb-3">
                                                            <label for="Choose Sts" class="border-bottom mb-1"> ~ Status ~</label>
                                                        ...
                                                        <div class="col-md-6 border-end-lg mb-3">
                                                            <label for="Choose Partner" class="border-bottom mb-1"> ~ Partner ~</label>
                                                            <select class="js-example-basic-single form-select"
                                                                data-width="100%" name="prt_id" id="dt-adm-prt-select">
                                                                <option value="">- Choose -</option>
                                                        ...
                                                        <div class="col-md-6 mb-4">
                                                            <label for="Choose Project" class="border-bottom mb-1"> ~ Project ~</label>
                                                            <select class="js-example-basic-single form-select"
                                                                data-width="100%" name="sort_prj_report" id="dt-adm-get-prj">
                                                                <option value="">- Choose -</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <label for="Choose SP" class="border-bottom mb-1"> ~ Service Point ~</label>
                                                            <select class="js-example-basic-single form-select"
...
@push('custom')
    <script>
        ...
        $(function() {
            var partnerSelect = $('#dt-adm-prt-select');
            var projectSelect = $('#dt-adm-get-prj');
            var selectedPartner = '{{ $prt }}';

            if (selectedPartner !== '') {
                partnerSelect.val(selectedPartner);
                dtProject('{{ route('GetdtProject') }}', partnerSelect.val(), 'dt-adm-get-prj');
            } else {
                projectSelect.empty();
            ...
            partnerSelect.on('change', function() {
                ...
                if (selectedPartnerId === '') {
                    ...
                    dtProject('{{ route('GetdtProject') }}', selectedPartnerId, 'dt-adm-get-prj');
                }
            });
        });
    </script>
