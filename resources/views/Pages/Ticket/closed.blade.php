                                                                ...
                                                                <div class="mb-3">
                                                                    <div class="input-group flatpickr" id="flatpickr-date">
                                                                        <input type="text" class="form-control"
                                                                            placeholder="Select Date" name="stCl_date"
                                                    ...
                                                    <div class="btn-group me-2" role="group" aria-label="First group">
                                                        @if ($depart == 4 && $role == 19)
                                                            <form
                                                                ...
                                                                id="form-return-ticket{{ $no }}"
                                                                method="post">
                                                                @csrf
                                                                {{ method_field('patch') }}
                                                            </form>
                                                            <button type="button"
                                                                class="btn btn-inverse-secondary btn-icon btn-sm btn-return-ticket{{ $no }}">
        ...
        $('.btn-return-ticket' + i + '').on('click', function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    jQuery('#form-return-ticket' + i + '').submit();
                }
            });
            return false;
        });
