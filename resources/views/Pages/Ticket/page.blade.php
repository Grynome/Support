                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                                    {{-- <a class="dropdown-item d-flex align-items-center"
                                        href="{{ url('helpdesk/form=TabsTicket') }}"><i data-feather="eye"
                                            class="icon-lg me-2"></i> <span class="">Tab View</span></a> --}}
                                    <a class="dropdown-item d-flex align-items-center create" href="javascript:;"><i
                                            data-feather="save" class="icon-lg me-2"></i> <span class="">Create
                                            Ticket</span></a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group flatpickr" id="flatpickr-dtc">
                                            <input type="text"
                                                class="form-control dt-incoming-tc"
                                ...
                                <div class="col-md-12">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <label for="reference" class="form-label">Category Part</label>
                                                                        <select class="js-example-basic-single form-select" data-width="100%"
                                                                            name="kat_part" id="kat-part">
                                                                            <option value="">- Choose -</option>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <textarea id="problematika" class="form-control" name="problematika" rows="2"
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="mb-3">
                                                                                <div class="d-flex justify-content-between align-items-baseline">
                                                                                    ...
                                                                                    :</label>
                                                                                    <a href="#" id="refresh-type-company">
                                                                                        <i class="icon-sm" data-feather="rotate-cw"></i>
                                                                                    </a>
                                                                                </div>
                                                                                <select
                                                                            ...
                                                                            <div class="col">
                                                                                <div class="mb-3">
                                                                                    <label for="severity_4"
                                                                                        ...
                                                                                        :</label>
                                                                                    <textarea class="form-control" id="adds-validate" rows="3" placeholder="Type Address"
                                                                                        name="addres_cst"></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col">
                                                                                    <div class="mb-3">
                                                                                        <label class="form-label">Ext. Phone
                                                                                            :</label>
                                                                                        <input
                                                                                            class="form-control mb-4 mb-md-0"
                                                                                            name="phone_ext"
        ...
        $('#refresh-source').click(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var options = '<option value="">- Choose -</option>';
                    for (var i = 0; i < data.length; i++) {
                        options += '<option value="' + data[i].id + '">' + data[i].sumber_name + '</option>';
                    }
        ...
        $('#refresh-sla').click(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var options = '<option value="">- Choose -</option>';
                    for (var i = 0; i < data.length; i++) {
                        options += '<option value="' + data[i].id + '">' + data[i].sla_name + '</option>';
                    }
                    $('#id-sla').html(options);
                },
                error: function() {
        ...
        $('#refresh-merk-unit').click(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var options = '<option value="">- Choose -</option>';
                    for (var i = 0; i < data.length; i++) {
                        options += '<option value="' + data[i].id + '">' + data[i].merk + '</option>';
                    }
        ...
        $('#refresh-partner').click(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var options = '<option value="">- Choose -</option>';
                    for (var i = 0; i < data.length; i++) {
                        options += '<option value="' + data[i].partner_id + '">' + data[i].partner + '</option>';
                    }
        ...
        $('#refresh-type-company').click(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var options = '<option value="">- Choose -</option>';
                    for (var i = 0; i < data.length; i++) {
                        options += '<option value="' + data[i].office_type_id + '">' + data[i].name_type + '</option>';
                    }
        ...
        $('#refresh-location').click(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var options = '<option value="">- Choose -</option>';
                    for (var i = 0; i < data.length; i++) {
                        options += '<option value="' + data[i].id + '">' + data[i].severity_name + '</option>';
                    }
